...
//
// Reusable deploy-time Lambda code-signing construct.
//
...
//
// IMPORTANT: the signing provider Lambda is intentionally NOT placed under a
...
export class SignedLambdaArtifact extends Construct {
  ...
  constructor(scope: Construct, id: string, props: SignedLambdaArtifactProps) {
    ...
    // CodeSigningConfig — this is CDK-internal tooling.
    ...
    // ========================================================================
    // cdk-nag suppressions — signing provider Lambda (CDK-internal tooling)
